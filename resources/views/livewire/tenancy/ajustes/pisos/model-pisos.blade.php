<div x-cloak x-data="{
        open: false,
        mode: 'create',
        piso: { id: null, nombre: '', impresora_id: '', status: true }
    }"
    x-on:open-piso.window="
        mode='create';
        piso={id:null,nombre:'',impresora_id:'',status:true};
        open=true
    "
    x-on:edit-piso.window="
        mode='edit';
        piso=$event.detail;
        open=true
    "
    x-on:close-piso.window="open=false"
>
    <div x-show="open" class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50"
        ...
        <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6 mx-2 sm:mx-0" @click.stop>
            ...
            <h2 class="text-lg font-semibold text-gray-700 mb-4">
                <span x-text="mode === 'edit' ? 'Editar Piso' : 'Nuevo Piso'"></span>
            </h2>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <x-text-input id="nombre" type="text" x-model="piso.nombre" placeholder="Ejm: Piso 1"
                ...
                <div class="flex items-center">
                    <input id="status" type="checkbox" x-model="piso.status" class="rounded border-gray-300">
            ...
            <div class="mt-6 flex justify-end space-x-2">
                ...
                <x-button type="button" color="blue" wire:click="save(piso)">
